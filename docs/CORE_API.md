...
- `VAGICore.forward(input_ids, obs=None, state=None, labels=None, targets=None, return_loss=False)`
- `VAGICore.step(input_ids, obs, state)`
- `VAGICore.plan_step(input_ids, obs, state, num_candidates=4, horizon=3, uncertainty_weight=1.0)`
